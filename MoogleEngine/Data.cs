...
public class Data{   
    ...
    public Data(){ } //Bob
    public void Peso(Dictionary<string, double> GFiler){ // este es el metodo q calcula el peso de cada palabra en el documento y le da valor al Module del documento
