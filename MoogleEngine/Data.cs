...
public class Data{   
    public Dictionary<string, List<int>> vocabulario = new Dictionary<string, List<int>>(); // este es el vocabulario del documento contra los indices de las palabras de dicho vocabulario
    ...
    public Data(){ } //Bob
    public void Peso(Dictionary<string, double> vocabulariogeneral){ // este es el metodo q calcula el peso de cada palabra en el documento y le da valor al Module del documento
